...
# To be public
using STLCutters: reset!, compact!, compute_in_out!, num_dfaces, get_faces, face_dimension, local_dface, global_dface, get_vertex_coordinates, get_face_coordinates, compute_cell_mesh!

# Private used in test
using STLCutters: _add_vertex!, UNSET, are_all_faces_defined, cut_cell_mesh!, find_closest_face, expand

using STLCutters: is_any_face_repeated
